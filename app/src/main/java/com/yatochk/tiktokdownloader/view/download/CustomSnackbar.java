...
class CustomSnackbar extends BaseTransientBottomBar<CustomSnackbar> {
    ...
    public static CustomSnackbar make(@NonNull ViewGroup parent, @BaseTransientBottomBar.Duration int duration) {
        final LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        final View content = inflater.inflate(R.layout.snack, parent, false);
